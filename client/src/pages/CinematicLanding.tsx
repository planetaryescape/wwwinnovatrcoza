      ...
      <div ref={contentRef}>
        ...
        <section id="consult-contact" className="relative min-h-screen bg-[#0a0a0f] flex flex-col justify-center overflow-hidden">
          ...
          <div className="relative w-full flex items-center">
            ...
            >
              {/* Sweeping curved arrow pointing left */}
              <svg 
                viewBox="0 0 200 80" 
                className="w-28 h-12 sm:w-36 sm:h-14 md:w-48 md:h-16 mr-4 sm:mr-6"
                fill="none"
                stroke="white"
                strokeWidth="4"
                strokeLinecap="round"
              ...
              >
                <motion.path
                  d="M195 10 C160 5, 100 5, 60 30 C30 50, 15 60, 10 55"
