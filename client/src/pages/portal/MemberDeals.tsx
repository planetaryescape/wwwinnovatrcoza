...
const exclusiveDealsData: ExclusiveDeal[] = [
  {
    ...
    description: "Buy 2 Basic credits and receive a 3rd at 50% off. Perfect for testing multiple concepts this quarter.",
    termsNote: "Member pricing applied. 3rd credit at R2,500.",
    totalSlots: 3,
    claimedSlots: 1,
    expiresLabel: "28 Feb",
    badge: "2 Left",
  ...
  },
  {
    ...
    description: "Experience a full Test24 Pro study at an introductory rate. Reserved for companies who haven't run Pro before.",
    termsNote: "One-time offer for first-time Pro buyers only.",
    totalSlots: 3,
    claimedSlots: 0,
    expiresLabel: "28 Feb",
    badge: "3 Left",
