...
export default function CheckoutMembershipPlatinum() {
  ...
  useSEO({
    title: "Scale Membership",
    description: "Get the Innovatr Scale Membership for enterprise-level insights. Includes 15 Basic credits, 3 Pro studies, dedicated support, and white-label reporting.",
    canonicalUrl: "https://www.innovatr.co.za/checkout/membership-platinum",
  });
