...
const services: Service[] = [
  {
    ...
    description: "Quick Concept Testing – Pay Per Idea",
    priceZAR: 5000,
    priceSuffix: " / idea",
    link: "/test24-basic",
    features: [
      "100 consumer responses in 5 minutes",
  ...
  },
  {
    ...
    description: "Full Research Studies with AI Insights",
    priceZAR: 45000,
    pricePrefix: "From ",
    priceSuffix: " / study",
    link: "/test24-pro",
    features: [
      "In-depth 15-minute surveys",
      "Custom audience targeting",
      "Quant data + AI qualitative analysis",
    ],
    color: "#B5A4D4",
    isNew: false,
  },
  {
    ...
    description: "Stay Ahead with Trend Reports",
    priceZAR: 5000,
    priceSuffix: " / month",
    link: "/innovatr-intelligence",
    features: [
      "Trend monitoring & competitor alerts",
  ...
  },
  {
    ...
    description: "Strategic Innovation Partnership",
    priceZAR: null,
