            ...
            {NAV_LINKS.map((link) => (
              <a
                ...
                style={{
                  ...
                  fontSize: 14,
                  fontWeight: link.label === "Our Tools" ? 600 : 500,
                  color: link.label === "Our Tools" ? BRAND.coral : BRAND.dark,
                  textDecoration: "none",
                  padding: "6px 12px",
                  borderRadius: 6,
                ...
                onMouseLeave={(e) => {
                  (e.target as HTMLElement).style.color = link.label === "Our Tools" ? BRAND.coral : BRAND.dark;
